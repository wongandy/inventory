<div class='row'>
	<div class="col-md-4">
		<div class="box">
			...
			<?php echo form_open(base_url() . 'item/item_in_process', array('id'=>'form_item_in', 'autocomplete'=>'off')); ?>
			<div class="box-body">
			...
			<div class="box-footer">
				<button type='submit' class='btn btn-info' id='item_in_button'>Item In</button>
			</div>
			<?php
